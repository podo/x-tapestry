...
- The author identity is always populated from the post author, including the X profile avatar when the payload provides one.
- Native media attachments are emitted before the post body: photos, videos, and animated GIFs retain their thumbnail, MIME type, dimensions, and alt text when available. A post may contain up to four media attachments.
